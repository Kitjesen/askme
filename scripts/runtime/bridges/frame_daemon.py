...
Usage:
    python3 scripts/runtime/bridges/frame_daemon.py
    python3 scripts/runtime/bridges/frame_daemon.py --color /camera/color/image_raw --rate 5 --bpu-model /path/to.hbm

Install as service:
    sudo cp scripts/runtime/services/askme-frame-daemon.service /etc/systemd/system/
