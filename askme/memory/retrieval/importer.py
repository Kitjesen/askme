...
SUPPORTED_CATEGORIES = SUPPORTED_KNOWLEDGE_CATEGORIES
...
class KnowledgeRecord:
    ...
    def normalized_category(self) -> str:
        return normalize_knowledge_category(self.category)
    ...
    def to_metadata(self) -> dict[str, Any]:
        ...
        return {
            ...
            "category_schema_version": category_meta.get("schema_version", ""),
            "source": self.source,
            "owner": self.owner,
...
def _record_from_mapping(
    ...
    *,
    ...
    return KnowledgeRecord(
        ...
        quality_status=str(item.get("quality_status") or item.get("quality") or ""),
        visibility=str(item.get("visibility") or item.get("answer_scope") or ""),
        customer_id=str(item.get("customer_id") or item.get("customer") or ""),
        project_id=str(item.get("project_id") or item.get("project") or ""),
        product_area=str(item.get("product_area") or item.get("product") or ""),
        workstream=str(item.get("workstream") or item.get("initiative") or ""),
        linked_object_type=str(item.get("linked_object_type") or item.get("object_type") or ""),
        linked_object_id=str(item.get("linked_object_id") or item.get("object_id") or ""),
        document_type=str(item.get("document_type") or item.get("doc_type") or Path(source).suffix.lstrip(".").lower()),
        metadata=metadata,
    )
