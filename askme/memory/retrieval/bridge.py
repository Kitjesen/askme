...
class MemoryBridge:
    ...
    def health(self) -> dict[str, Any]:
        ...
        vector_dependency = backend_dependencies.get("vector")
        if isinstance(vector_dependency, dict) and "dependency_installed" in vector_model_status:
            vector_dependency["installed"] = bool(
                vector_model_status["dependency_installed"]
            )
        mempalace_health = (
