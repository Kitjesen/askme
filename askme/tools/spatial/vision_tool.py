"""Vision tools for askme — exposes vision-port capabilities to the agent shell.
...
if TYPE_CHECKING:
    from askme.ports import VisionPort
...
class LookAroundTool(BaseTool):
    ...
    def set_vision(self, vision: VisionPort) -> None:
        self._vision = vision
...
def register_vision_tools(
    ...
    """Register vision tools with the given vision port."""
    look = LookAroundTool()
