...
class MuteMicTool(BaseTool):
    ...
    def __init__(self, audio: AudioFrontendPort) -> None:
        self._audio = audio
...
def register_voice_tools(registry: ToolRegistry, audio: AudioFrontendPort) -> None:
    """Instantiate and register all voice control tools, injecting the audio port."""
