...
DASHBOARD_PAGE_SPECS: tuple[DashboardPageSpec, ...] = (
    DashboardPageSpec(
        ...
        title="现场任务平台",
        kicker="产品总览",
        description="把语音入口、客户项目、现场事件、知识库、能力中心和交付检查拆开验收。",
        audience="customer",
        section="customer",
        order=10,
        hint="功能地图",
    ...
    DashboardPageSpec(
        ...
        title="客户项目与对象目录",
        kicker="方案商交付",
        description="为不同客户维护现场对象、行业模板、设备协议、能力包和验收用例。",
        audience="operator",
        section="operations",
        order=80,
        hint="对象目录",
        primary_endpoint="/api/field/customer-project-workbench",
        evidence_promises=("项目范围", "对象绑定", "交付包"),
    ),
    DashboardPageSpec(
        key="voice",
        ...
        title="语音音色和实时链路",
        kicker="声音系统",
        description="按巡检、访客、安防、紧急告警和夜间低扰场景管理音色和播报策略。",
        audience="operator",
        section="operations",
        order=90,
        hint="播报策略",
        primary_endpoint="/api/voice/profiles",
        evidence_promises=("音色", "播报策略", "链路状态"),
    ),
    DashboardPageSpec(
        key="delivery",
