...
Usage::
    ...
    from askme.runtime.core.module import Module, Runtime, In, Out
...
class Runtime:
    ...
    def module_names(self) -> tuple[str, ...]:
        """Return the declared module composition without exposing internals."""
        return tuple(module_class.name for module_class in self._module_classes)
