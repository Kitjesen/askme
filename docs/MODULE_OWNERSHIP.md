...
| Product workflows | `askme/pipeline/field`, field route services | Core runtime graph, low-level providers | `pytest tests/test_field_operations.py tests/test_field_ingest_adapters.py tests/test_field_contracts.py tests/test_dashboard_customer_project_contract.py -q` |
...
| --- | --- | --- | --- |
| `agent_shell` | agent execution shell and profiles | runtime graph, MCP/API transport | `pytest tests/test_agent_profiles.py tests/test_thunder_agent_shell.py -q` |
